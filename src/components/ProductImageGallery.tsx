const ProductImageGallery = () => {
  return (
    <div className="space-y-4">
      <div className="aspect-w-1 aspect-h-1 bg-subtle-light dark:bg-subtle-dark rounded-lg overflow-hidden border border-subtle-light dark:border-subtle-dark">
        <img
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden border-2 border-primary ring-2 ring-primary/50">
          <img
            alt="Thumbnail 1"
            className="w-full h-full object-cover object-center"
        ...
        <div className="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden opacity-75 hover:opacity-100 transition-opacity">
          <img
            alt="Thumbnail 2"
            className="w-full h-full object-cover object-center"

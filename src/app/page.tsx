        ...
        <div className="container mx-auto flex items-center justify-between px-4 py-3 lg:px-8">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden items-center gap-6 lg:flex">
              {[
                ...
                <a key={label} className="text-sm font-medium hover:text-[var(--color-primary)]" href="#">
                  {label}
                </a>
              ))}
              <a className="rounded-full bg-[var(--color-accent-orange)] px-3 py-1 text-sm font-bold text-white hover:bg-opacity-90" href="#">
                Promotions
              </a>
            </nav>
          </div>
          <div className="flex items-center gap-3">
            <div className="relative hidden md:block">
              <input className="w-full rounded-full border-[var(--color-subtle-light)] bg-[var(--color-background-light)] py-2 pl-10 pr-4 text-sm focus:border-[var(--color-primary)] focus:ring-[var(--color-primary)]" placeholder="Rechercher..." type="search" />
            ...
            <button className="rounded-full p-2 hover:bg-[var(--color-subtle-light)]">
              <svg fill="currentColor" height="24px" viewBox="0 0 256 256" width="24px" xmlns="http://www.w3.org/2000/svg">
                <path d="M178,32c-20.65,0-38.73,8.88-50,23.89C116.73,40.88,98.65,32,78,32A62.07,62.07,0,0,0,16,94c0,70,103.79,126.66,108.21,129a8,8,0,0,0,7.58,0C136.21,220.66,240,164,240,94A62.07,62.07,0,0,0,178,32ZM128,206.8C109.74,196.16,32,147.69,32,94A46.06,46.06,0,0,1,78,48c19.45,0,35.78,10.36,42.6,27a8,8,0,0,0,14.8,0c6.82-16.67,23.15-27,42.6-27a46.06,46.06,0,0,1,46,46C224,147.61,146.24,196.15,128,206.8Z"></path>
              </svg>
            </button>
            <button className="relative rounded-full p-2 hover:bg-[var(--color-subtle-light)]">
              <svg fill="currentColor" height="24px" viewBox="0 0 256 256" width="24px" xmlns="http://www.w3.org/2000/svg">
                <path d="M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40Zm0,160H40V56H216V200ZM176,88a48,48,0,0,1-96,0,8,8,0,0,1,16,0,32,32,0,0,0,64,0,8,8,0,0,1,16,0Z"></path>
              </svg>
              <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-[var(--color-accent-orange)] text-xs font-bold text-white">2</span>
            </button>
            <button className="rounded-full p-2 hover:bg-[var(--color-subtle-light)] lg:hidden">
